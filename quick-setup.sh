...
# Quick setup for WhtzUp Events on Digital Ocean
# This script sets up the server with minimal dependencies
...
print_step "Step 2: Installing Docker Compose..."
...
print_step "Step 8: Cloning from GitHub..."
git clone https://github.com/indrek777/whtzup-app.git .

print_step "Step 9: Setting up environment..."
cat > .env << 'EOF'
NODE_ENV=production
PORT=4000
...
print_step "Step 10: Setting up PostgreSQL..."
...
print_step "Step 11: Configuring PostgreSQL..."
...
print_step "Step 12: Configuring Redis..."
...
print_step "Step 13: Setting up Nginx..."
...
print_step "Step 14: Starting the application..."
chmod +x deploy.sh
